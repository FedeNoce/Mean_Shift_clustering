...
def main():
    ...
    generate_dataset(points=10000, n_features=2, centers=3, std=1, file_name=f'2D_data_3.csv', centroids_file_name=f'2D_data_3_centroids.csv', output_directory=DATASETS_DIR)
